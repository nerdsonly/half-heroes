#==================================================================================================
# RPG Maker VXAce to MV Project Converter 
#==================================================================================================
#  1. RPGツクールMVの新しいプロジェクトを作成してください。これが、あなたのVXAceのプロジェクトのMV版になります。
#  2. MVのプロジェクトを一旦閉じて、コンバートの対象となるVXAceのプロジェクトを開いてください。
#  3. スクリプトエディタを開きます。Mainより上、Materialsの下に新しいスロットを作成してください。
#  4. このスクリプトからコンテンツをそのスロットに貼り付けてください。OKを押し、プロジェクトを保存します。 
#  5. ゲームをプレイし終わるとmv-dataという新しいフォルダが出来上がりますので、ゲームを終了します。
#     全てのカスタムスクリプトは消去されていることが推奨されます。
#  6. .Jsonファイルをコピーし、MV-DATAのフォルダ内に置いてください。
#  7. 最初に作ったMVプロジェクトのデータフォルダ内のjsonファイルを、置き換えてください。MVでプロジェクトを開くと、データベースが適用され、マップがコンバートされているはずです。
#  8. 素材については、VXAceからMVに手動で移す必要があります。 
#==================================================================================================
module DEGICA
  module CONVERT
    FOLDER = 'mv-data/'
