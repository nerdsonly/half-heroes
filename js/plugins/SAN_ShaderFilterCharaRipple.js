 ...
 * Display a ripple effect around the character.
 * @author Sanshiro https://github.com/rev2nym
 * @help
 * - Overview
 * This plugin provides an effect filter that displays
 * ripples around the character.
 ...
 * 
 * - Shader code file
 * This plugin requires that you have "SAN_CharaRippleFrag.txt" placed in the
 ...
 * This specifies the ID of the character that is at the center of the effect.
 * If the character type is set to 'follower', the follower index corresponds  
 * to the position of the actor in the chain (the ID of the 2nd actor in the party is 1),
 * if the character type is set to 'event', it uses the event ID.
 * If omitted, it is set to 1 by default.
 * 
 * - Effect pitch: pitch
